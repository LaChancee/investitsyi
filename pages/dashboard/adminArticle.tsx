                            ...
                            <ul className={"gap-6 grid"}>
                                <li>
                                    <label htmlFor="subject"
                                           className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Titre de l'article</label>
                                ...
                                {/*Markdinw nécéssaire Rich text editor*/}
                                <li>
                                    <label htmlFor="content"

                                           className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Contenu</label>
                                ...
                                <li>
                                    <div className=" items-center justify-center w-full">
                                        <label htmlFor="detail"
                                               className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Image de couverture</label>
