            ...
            <main className={"grid grid-cols-3 bg-white "}>
                ...
                <div className={"grid col-span-2 content-start p-8 gap-4 px-40"}>
                    <div className={"flex justify-center pb-30"}>
                        <h1 className={"text-5xl justify-center"}>Connexion via les <span className={"font-semibold"}> résaux sociaux </span>
                        </h1>
                    </div>
                    <div>
                        <div>
                            ...
                            {status === 'authenticated' && (
                                <div>
                                    <span
                                        className={"flex text-2xl justify-center font-semibold"}>Signed in as {session.user?.email}</span>
                                    <button
                            ...
                            {status === 'unauthenticated' && (
                                <div>
                                    <div className={"flex gap-3 py-10 justify-center"}>
                                        ...
                                        >
                                            <Image src={twitter} alt={"Logo twitter"} width={40}
                                        ...
                                        >
                                            <Image src={facebook} alt={"Logo facebook"} width={90}
                                                   className={"grayscale hover:grayscale-0"}/>
                                        </button>
                                    </div>
                                </div>
                    ...
                    <form className={"grid content-center gap-4 "} onSubmit={handleSubmit}>
                        ...
                        <div className={"flex gap-2"}>
                            <button type="submit"
                                    className={"inline-flex w-fit items-center justify-center px-6 py-2 mr-3 text-base font-medium text-center text-white rounded-full bg-primary transition duration-300 hover:shadow-xl hover:shadow-primary/30  focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900"}>
                                Se connecter
                            </button>
                            <a href={"/"} className={"text-md text-primary self-center hover:underline"}>Annuler </a>
                        </div>
                        <span>Vous n'avez pas de compte ? <Link href={"/Register"}
                                                                className={"text-primary underline underline-offset-2"}>Inscrivez-vous </Link> </span>
