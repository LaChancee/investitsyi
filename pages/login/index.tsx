                ...
                <div className="grid col-span-2 content-start p-8 gap-4 px-40">
                    <div className="flex justify-center pb-30">
                        <h1 className="text-5xl justify-center">
                            Connexion via les{" "}
                            <span className="font-semibold"> résaux sociaux </span>
                        </h1>
                    </div>
                    <div>
                        <div>
                            ...
                            {status === "authenticated" && (
                                <div>
                  <span className="flex text-2xl justify-center font-semibold">
                    ...
                    <form className="grid content-center gap-4" onSubmit={handleSubmit}>
                        ...
                        <div className="flex gap-2">
                            ...
                            <Link
                                href={"/"}
                                className="text-md text-primary self-center hover:underline"
                            >
                                Annuler
                            </Link>
                        </div>
